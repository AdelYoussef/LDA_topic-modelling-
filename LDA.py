...
class LDA :
    ...
    def doc2bow_dict(self, data):
        ...
        self.bow_corpus = [self.dictionary.doc2bow(self.data_train) for doc in self.data_train]
    ...
    def train(self,Filter = True , multicore = True , cores = 2 , batch_size = 10 , epochs = 50 ,  num_topics=10):
        self.multicore = multicore
        self.Filter = Filter
        self.processed_docs = self.preprocess(self.newsgroups_train)
